<template>
  <el-form label-position="right" label-width="80px" :model="rootData2" :rules="rules" ref="ruleForm">
        ...
        <template v-if='isView'>
          <div class="just-show">
            <el-form-item label="英文:">
              <span>{{rootData.en}}</span> <starIcon :baseData='rootData' :inDetail='true'  starType='phrase' @dialogHandlerSuccess='dialogHandlerSuccess'></starIcon>
            </el-form-item>
    ...
    <template v-if='!isAdd'>
      ...
      <Comment v-if='rootData && rootData.id' targetType='phrase' :targetId='rootData.id'></Comment>
    </template>
